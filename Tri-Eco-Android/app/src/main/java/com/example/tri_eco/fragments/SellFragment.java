...
public class SellFragment extends Fragment {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (condition.isEmpty()) {
                    Toast.makeText(getContext(), "Condition can't be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (email.isEmpty()) {
                    Toast.makeText(getContext(), "Contact Info can't be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void launchCamera() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(getContext(), "com.codepath.fileprovider.trieco", photoFile);
