...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (price.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Price can't be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (condition.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Condition can't be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (email.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Contact Info can't be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                savePost(description,title,condition,price,email, currentUser, photoFile);
            }
        });
    }
    ...
    private void launchCamera() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(MainActivity.this, "com.codepath.fileprovider.trieco", photoFile);
